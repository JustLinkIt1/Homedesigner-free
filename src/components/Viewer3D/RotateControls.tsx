...
export default function RotateControls() {
  ...
  return (
    <div className="rotate3d-pill" aria-label="Rotate object">
      <button onClick={() => rot(-45)} aria-label="Rotate left 45 degrees">
        <RotateCcw className="icon" />
      </button>
      <span className="val">{Math.round(norm360(item.rotation))}°</span>
      <button onClick={() => rot(45)} aria-label="Rotate right 45 degrees">
