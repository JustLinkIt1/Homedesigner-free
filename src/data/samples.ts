...
function familyHouse(): MaybeFloored {
  ...
  const groundGeom: FloorGeom = {
    ...
    furniture: [
      ...
      fur('rug', 280, 250),
      fur('sofa', 430, 250, 90), // back to the kitchen wall, faces west
      fur('coffee_table', 300, 250),
      fur('tv_stand', 40, 250, 90), // on the west wall, faces east
      fur('armchair', 300, 80, 25),
      fur('bookshelf', 450, 25, 0),
      ...
      fur('dining_chair', 745, 270, 0),
      fur('dining_chair', 855, 270, 0),
      fur('dining_chair', 745, 395, 180),
      fur('dining_chair', 855, 395, 180),
      fur('pendant', 800, 330),
      // Hall — stairs rise along the south wall.
      fur('stairs', 130, 660, 90),
      fur('console', 420, 530, 0),
  ...
  const upperGeom: FloorGeom = {
    ...
    furniture: [
      ...
      fur('dresser', 430, 330, 270),
      fur('rug', 250, 320),
      fur('ceiling_light', 250, 250),
      // Kids room
      fur('bed_single', 620, 150),
      fur('nightstand', 540, 60),
      fur('desk', 900, 300, 270),
      fur('office_chair', 830, 300, 90),
      fur('bookshelf', 960, 60, 90),
      fur('rug', 720, 320),
